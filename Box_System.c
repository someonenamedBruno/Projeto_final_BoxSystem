...
// Definindo as cores que os objetos podem ter
int colors[6][3] = {
    {32, 32, 32},   // Branco
    {32, 0, 0},   // Vermelho
    {0, 32, 0},   // Verde
...
int current_color_index = 0; // Índice da cor selecionada
...
// Função para tentar colocar o objeto na matriz de LEDs
int placeObjectInMatrix(Object obj) {
    ...
    // Tenta encontrar um espaço vazio na matriz para colocar o objeto
